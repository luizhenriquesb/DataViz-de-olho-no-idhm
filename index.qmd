...
Esses indicadores estão originalmente disponíveis no Atlas do Desenvolvimento Humano no Brasil. No entanto, a equipe da Associação Brasileira de Jurimetria facilita o acesso a esses dados através do pacote `abjData`.
...
```{r, fig.align='center', fig.height=6, fig.width=10, fig.width=10}
p10 +
...
```{r, fig.show='animate', fig.s, fig.align='center', fig.height=6, fig.width=10, fig.width=10}
#| echo: false
p1
p2
p3
